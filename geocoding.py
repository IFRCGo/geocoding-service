...
"""
Note that the source of this file is https://github.com/IFRCGo/pystac-monty/blob/main/pystac_monty/geocoding.py (commit: 30aff67)
Make sure to sync it before using it.
"""
